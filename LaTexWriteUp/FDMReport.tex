...
%I feel like I grasp this somewhat, but I can't develop it in a way that I'm satisfied with. 
...
% I think we should mention the FFT, but not go into detail. It's a bit beyond the scope of the project.
...
%File compression by limiting bandwidth, image compression (same thing but in spacial domain), modulating signals in general
